...
<?php foreach ($faturas as $b): ?>
            <div class="mut-grid-16" role="row"><div class="mut-misc-16" role="cell"><?= e($b['venc']) ?></div><div class="mut-heading-x" role="cell"><?= e($b['valor']) ?></div><div role="cell"><span class="mut-status mut-status--<?= e($b['statusClasse']) ?>"><?= e($b['status']) ?></span></div><div class="mut-misc-13" role="cell"><a href="segunda-via.php" aria-label="Ver 2ª via da fatura de <?= e($b['venc']) ?>" class="mut-card-24">2ª via</a></div></div>
<?php endforeach; ?>
          </div>
