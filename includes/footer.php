  ...
  <footer style="background:var(--surface); border-top:1px solid var(--border); padding:64px 0 0;">
    <div class="footer-grid" style="max-width:1240px; margin:0 auto; padding:0 24px; display:grid; grid-template-columns:1.6fr 1fr 1.2fr 1fr; gap:40px;">
      <div>
        <div style="position:relative; display:inline-block; font-family:'Archivo',sans-serif; font-weight:800; font-size:26px; letter-spacing:-1.5px; color:var(--primary); line-height:1;">MUT<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="13" height="13" fill="var(--accent)" style="position:absolute; top:-8px; right:-7px;"><path d="M13 2L4 14h6l-1 8 9-12h-6z"/></svg></div>
      ...
      <div>
        <h2 style="font-family:'Archivo',sans-serif; font-weight:700; font-size:15px; margin:0 0 16px;">Atendimento</h2>
        <div style="display:grid; gap:12px; font-size:14px; color:var(--muted);">
          <div style="display:flex; align-items:center; gap:9px;"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--primary)" stroke-width="2" stroke-linecap="round"><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3-8.6A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .4 1.9.7 2.8a2 2 0 0 1-.5 2.1L8.1 9.9a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.4c.9.3 1.8.6 2.8.7a2 2 0 0 1 1.7 2z"/></svg><span>Telefone: (82) 3000-0000</span></div>
          <div style="display:flex; align-items:center; gap:9px;"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12 2a10 10 0 0 0-8.7 14.9L2 22l5.3-1.4A10 10 0 1 0 12 2z"/></svg><span>WhatsApp (82) 9 9999-9999</span></div>
          <div style="display:flex; align-items:center; gap:9px;"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--primary)" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 7l10 6 10-6"/></svg><span>contato@muttelecom.com.br</span></div>
          <div style="display:flex; align-items:flex-start; gap:9px;"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--primary)" stroke-width="2" style="margin-top:2px;"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2" stroke-linecap="round"/></svg><span>Seg a Sáb, 8h às 20h</span></div>
        </div>
      </div>
      <div>
        <h2 style="font-family:'Archivo',sans-serif; font-weight:700; font-size:15px; margin:0 0 16px;">Cidades atendidas</h2>
...
<?php endforeach; ?>
    ...
    <div style="max-width:1240px; margin:38px auto 0; padding:22px 24px; border-top:1px solid var(--border); display:flex; flex-wrap:wrap; gap:18px; align-items:center; justify-content:space-between;">
      <div style="display:flex; gap:10px;">
        <a href="#" aria-label="Instagram da MUT Telecom (abre em nova aba)" target="_blank" rel="noopener" class="mut-social-link" style="width:38px; height:38px; border-radius:10px; border:1px solid var(--border); background:var(--background); display:flex; align-items:center; justify-content:center; color:var(--muted); cursor:pointer; text-decoration:none;"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor"/></svg></a>
        <a href="#" aria-label="Facebook da MUT Telecom (abre em nova aba)" target="_blank" rel="noopener" class="mut-social-link" style="width:38px; height:38px; border-radius:10px; border:1px solid var(--border); background:var(--background); display:flex; align-items:center; justify-content:center; color:var(--muted); cursor:pointer; text-decoration:none;"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M14 9h3V6h-3c-2.2 0-4 1.8-4 4v2H7v3h3v6h3v-6h3l1-3h-4v-2c0-.6.4-1 1-1z"/></svg></a>
      </div>
