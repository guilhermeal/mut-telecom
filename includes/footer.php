    ...
    <div class="footer-grid mut-misc-62">
      ...
      <div>
        ...
        <div class="mut-grid-11">
          ...
          <div class="mut-row-2"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12 2a10 10 0 0 0-8.7 14.9L2 22l5.3-1.4A10 10 0 1 0 12 2z"/></svg><span>WhatsApp (82) 9 9999-9999</span></div>
          <div class="mut-row-2"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="var(--primary)" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 7l10 6 10-6"/></svg><span>contato@muttelecom.com.br</span></div>
...
<?php endforeach; ?>
    ...
    <div class="mut-muted-125-2">CNPJ 00.000.000/0001-00 · © <?= date('Y') ?> MUT Telecom. Todos os direitos reservados.</div>
  </footer>
