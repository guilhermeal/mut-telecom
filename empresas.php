...
<div>
      <section class="mut-pos-19">
        ...
        <div class="mut-pos-17">
          ...
          <a class="mut-btn-17" href="contato">Falar com um consultor</a>
        </div>
      </section>
...
<?php endforeach; ?>
              ...
              <a class="mut-btn-5" href="contato">Solicitar proposta</a>
            </div>
<?php endforeach; ?>
          </div>
...
<?php else: ?>
          <div class="mut-card-25 mut-text-center">
            ...
            <a class="mut-btn-5" href="contato">Falar com um consultor</a>
          </div>
<?php endif; ?>
        </div>
      </section>
