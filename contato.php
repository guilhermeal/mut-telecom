      ...
      <section class="sec-pad mut-misc-18">
        <div class="split mut-misc-61">
          ...
          <div class="mut-grid-4">
            <a href="<?= e(mut_whatsapp_float_link()) ?>" target="_blank" rel="noopener" class="mut-lift mut-card-17"><div class="mut-misc-95"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M12 2a10 10 0 0 0-8.7 14.9L2 22l5.3-1.4A10 10 0 1 0 12 2z"/></svg></div><div><div class="mut-heading-15">WhatsApp</div><div class="mut-muted-135"><?= e(MUT_PHONE_TEL) ?></div></div></a>
