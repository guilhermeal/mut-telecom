...
<?php foreach ($businessPlans as $plan) mut_render_plan_card($plan); ?>
          ...
          <div style="margin-top:56px; background:var(--surface); border:1px solid var(--border); border-radius:22px; padding:30px;">
            ...
            <div class="grid-4" style="display:grid; grid-template-columns:repeat(4,1fr); gap:18px;">
              <div style="display:flex; align-items:center; gap:11px; font-size:14.5px;"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="var(--primary)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg>Instalação grátis</div>
              <div style="display:flex; align-items:center; gap:11px; font-size:14.5px;"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="var(--primary)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg>Roteador Wi-Fi incluso</div>
              <div style="display:flex; align-items:center; gap:11px; font-size:14.5px;"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="var(--primary)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg>Suporte local</div>
              <div style="display:flex; align-items:center; gap:11px; font-size:14.5px;"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="var(--primary)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg>App do assinante</div>
            </div>
          </div>
        </div>
      </section>
