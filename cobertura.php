      ...
      <section class="sec-pad" style="padding:20px 0 80px;">
        <div style="max-width:1240px; margin:0 auto; padding:0 24px;">
          <div class="split" style="background:var(--surface); border:1px solid var(--border); border-radius:24px; padding:36px; display:grid; grid-template-columns:1fr 1.1fr; gap:36px; align-items:center;">
            ...
            <div>
              <div id="mut-viab-success" class="hidden" role="status" aria-live="polite" style="text-align:center; padding:28px 16px;">
                <div aria-hidden="true" style="width:56px; height:56px; margin:0 auto 16px; border-radius:50%; background:rgba(31,138,91,.14); color:#1f8a5b; display:flex; align-items:center; justify-content:center;"><svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg></div>
              ...
              <form id="mut-viab-form" novalidate style="display:grid; gap:14px;">
                <div>
                  <label for="mut-viab-email" class="mut-visually-hidden">Seu e-mail</label>
                  <input id="mut-viab-email" name="email" type="email" class="mut-input" placeholder="Seu e-mail" aria-describedby="mut-viab-err-email" style="width:100%; padding:13px 15px; border-radius:11px; border:1.5px solid var(--border); background:var(--background); color:var(--foreground); font-size:15px; font-family:inherit; outline:none;">
                  <div id="mut-viab-err-email" class="hidden" role="alert" style="font-size:12.5px; color:var(--accent); margin-top:6px;"></div>
                </div>
                <div>
                  <label for="mut-viab-endereco" class="mut-visually-hidden">Endereço completo (rua, número, bairro, cidade)</label>
                  <input id="mut-viab-endereco" name="endereco" class="mut-input" placeholder="Endereço completo (rua, número, bairro, cidade)" aria-describedby="mut-viab-err-endereco" style="width:100%; padding:13px 15px; border-radius:11px; border:1.5px solid var(--border); background:var(--background); color:var(--foreground); font-size:15px; font-family:inherit; outline:none;">
                  <div id="mut-viab-err-endereco" class="hidden" role="alert" style="font-size:12.5px; color:var(--accent); margin-top:6px;"></div>
                </div>
